package com.vanguard.vpn.logger;
...
public class SkStatus
{
	...
	*/
	...
	private static ConnectionStatus getLevel(String state) {
        String[] noreplyet = {SSH_STARTING, SSH_CONNECTING, SSH_WAITING, SSH_RECONECTANDO, "RESOLVE", "TCP_CONNECT"};
