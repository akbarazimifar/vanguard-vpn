...
public class MaterialButton extends Button {
     ...
     private void initAttributes(Context context, AttributeSet attributeSet) {
          ...
          try {
               ...
               float defValue = 5;
               cornerRadius = attr.getDimension(R.styleable.MaterialButton_cornerRadius, defValue);
     ...
     private LayerDrawable createNormalDrawable(TypedArray attr) {
          ...
          int blueDark = getColor(R.color.button_pressed);
          int colorPressed = attr.getColor(R.styleable.MaterialButton_colorPressed, blueDark);
          ...
          int colorNormal = attr.getColor(R.styleable.MaterialButton_colorNormal, blueNormal);
