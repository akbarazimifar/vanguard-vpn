...
import com.vanguard.vpn.util.StreamGobbler;
import android.support.v4.content.ContextCompat;
import com.vanguard.vpn.logger.SkStatus;
import com.vanguard.vpn.util.CustomNativeLoader2;
	...
	public void run() {
		...
		if (mListener != null) {
 		...
 		try {
			...
			fileTun2Socks = CustomNativeLoader2.loadNativeBinary(mContext, TUN2SOCKS_BIN, new File(mContext.getFilesDir(),TUN2SOCKS_BIN));
